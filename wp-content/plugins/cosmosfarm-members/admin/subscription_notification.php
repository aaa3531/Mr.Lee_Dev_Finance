...
<div class="wrap">
	...
	<form method="get">
		<input type="hidden" name="page" value="cosmosfarm_subscription_notification">
		<?php $table->search_box(__('Search', 'cosmosfarm-members'), 'subscription_notification_search')?>
	</form>
	<form method="post">
		<?php $table->display()?>
	</form>
