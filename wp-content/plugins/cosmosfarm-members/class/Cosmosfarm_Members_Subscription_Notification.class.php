<?php
/**
 * Cosmosfarm_Members_Subscription_Notification
 * @link https://www.cosmosfarm.com/
 * @copyright Copyright 2020 Cosmosfarm. All rights reserved.
 */
class Cosmosfarm_Members_Subscription_Notification {
	
	var $post_type = 'cosmosfarm_subnoti';
	var $post;
	var $post_id = 0;
	...
	public function notification_post_type(){
		return 'cosmosfarm_subnoti';
	}
